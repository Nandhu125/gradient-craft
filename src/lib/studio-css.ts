...
export type CssScope = "body" | "hero" | "card";
...
export function generateCSS(
  ...
  // Context-specific container attributes
  if (scope === "body") {
    lines.push("  min-height: 100vh;");
    lines.push("  width: 100%;");
  } else if (scope === "hero") {
    lines.push("  min-height: 80vh;");
    lines.push("  width: 100%;");
