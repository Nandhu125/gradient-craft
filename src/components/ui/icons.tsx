...
function Ic({ children, size = 18, className }: { children: ReactNode; size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SurpriseIcon({ size = 15, style, className }: { size?: number; style?: React.CSSProperties; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ControlsIcon({ size = 14, className }: { size?: number; className?: string }) {
  return (
...
export function MonitorIcon({ size = 18, className }: { size?: number; className?: string }) {
  return (
    <Ic size={size} className={className}>
...
export function CardIcon({ size = 18, className }: { size?: number; className?: string }) {
  return (
    <Ic size={size} className={className}>
...
export function SmartphoneIcon({ size = 18, className }: { size?: number; className?: string }) {
  return (
    <Ic size={size} className={className}>
...
export function ContrastIcon({ size = 18, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="9" />
